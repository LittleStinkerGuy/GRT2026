...
import frc.robot.commands.auton.GoStraightBump;
...
public class RobotContainer {
    ...
    public Command getAutonomousCommand() {
        return new GoStraightBump(flywheelSubsystem, hoodSubsystem, tower, HopperSubsystem, pivotIntake, intakeSubsystem);
